...
public class FileChecker {
  ...
  public FileChecker(
    ...
    java.io.File configFile = new java.io.File(machinery.getDataFolder(), configurationFileName);
    loadedFiles.put(
        File.Type.CREATED,
          ...
          new File(
              ...
              YamlConfiguration.loadConfiguration(
                  new InputStreamReader(
                      fileManager.getConfigContent(
                          new InputStreamReader(machinery.getResource(configurationFileName)))))));
    } else {
      loadedFiles.put(
          File.Type.RESOURCE,
          new File(
  ...
  public static class File {
    ...
    public File(FileManager fileManager, java.io.File configFile, FileConfiguration configLoad) {
      ...
      if (configFile != null && configFile.getName().equals("config.yml")) {
        this.configLoad =
            YamlConfiguration.loadConfiguration(
                new InputStreamReader(fileManager.getConfigContent(configFile)));
      }
    }
