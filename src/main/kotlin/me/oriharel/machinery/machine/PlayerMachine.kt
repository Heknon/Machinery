...
class PlayerMachine(maxFuel: Int, fuelDeficiency: Int, machineType: MachineType,
                    ...
                    val playersWithAccessPermission: Set<UUID?>?, var totalResourcesGained: Double, var resourcesGained: Map<Material?, ItemStack?>?, var energyInMachine: Int, val machineCore: Location?, var zenCoinsGained: Double,
                    var totalZenCoinsGained: Double, val owner: UUID?, @field:JsonAdapter(AbstractUpgradeTypeAdapter::class) val upgrades: List<AbstractUpgrade?>?, @field:Transient val factory: MachineFactory) : Machine(maxFuel, fuelDeficiency, machineType, structure, recipe, machineType, machineName, openGUIBlockType, factory) {
